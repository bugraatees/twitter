    ...
    return (
        <div className="w-[600px]">
            ...
            <div className="p-8 pt-0 ">
                <p className="text-center text-[71767b] leading-5 text-[0.938rem] mb-5">
                    Bu ayarlar, bu tarayıcıda ki tüm X hesaplarını etkiler.
                </p>
                <div className="mx-8 mb-4">
                    ...
                    <div className="grid gap-3">
                        ...
                        <section>
                            <h6 className="text-[color:var(--color-base-secondary)] mb-1 leading-5 text-[13px] font-bold">Yazı tipiboyutu</h6>
                        ...
                        <section>
                            ...
                            <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
                                ...
                                >
                                    <div className="w-10 h-10 rounded-full flex-shrink-5 group-hover:bg-black/5 flex items-center justify-center">
                                        <div className={classNames("w-5 h-5 rounded-full border-2 border-[#b9cad3] flex items-center justify-center", {
                                            "!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] tex-white": backgroundColor.name === 'light'
                                        })}>
                                ...
                                <button
                                    ...
                                    className={classNames("h-16 pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] border font-bold border-white/10 rounded group flex items-center gap-1.5", {
                                        "! border-[color:var(--color-primary)] !border-2": backgroundColor === 'dark'
                                    })}

                                >
                                    <div className="w-10 h-10 rounded-full flex-shrink-5 group-hover:bg-white/5 flex items-center justify-center">
                                        <div className={classNames("w-5 h-5 rounded-full border-2 border-[#5c6e7e] flex items-center justify-center", {
                                            "!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] tex-white": backgroundColor.name === 'dark'
                                        })}>
                                ...
                                >
                                    <div className="w-10 h-10 rounded-full flex-shrink-5 group-hover:bg-white/10 flex items-center justify-center">
                                        <div className={classNames("w-5 h-5 rounded-full border-2 border-[#3e4144] flex items-center justify-center", {
                                            "!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] tex-white": backgroundColor.name === 'darker'
                                        })}>
