...
export default function More() {
    return (
        <Popover className="relative">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black rounded-xl overflow-hidden">
                <button
                ...
                <Disclosure>
                    ...
                    <Disclosure.Panel className="text-gray-500">
                        ...
                        <button
                            className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover: bg-[#eff3f41a] transition-colors text-white w-full"
                        >
                            <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                                <path
                                    fill="currentColor"
