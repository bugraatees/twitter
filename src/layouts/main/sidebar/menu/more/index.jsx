...
export default function More() {
    return (
        <Popover className="relative">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] rounded-xl overflow-hidden">
                <button
                    className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-third)]">
                    <div className="w-[1.641rem] h-[1.641rem] relative">
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25} >
                            <path
                                fill="currentColor"
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover: bg-[#eff3f41a]">
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover: bg-[color:var(--background-secondary)] transition-colors ">
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                                        <path
                                            fill="currentColor"
                                            d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2zz"
                                        />
                                    </svg>
                                    İstatistikler
                                </Link>
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover: bg-[color:var(--background-secondary]">
                                Ayarlar ve Destek
                                <svg viewBox="0 0 24 24" width={18.75} height={18.75} className={classNames({
                                    "rotate-180 text-[color:var(--color-primary)]": open
                                })} >
                            ...
                            <Disclosure.Panel>
                                ...
                                <button
                                    ...
                                    className="flex items-center px-3 h-11 gap-3 text-[15px] w-full font-medium hover: bg-[color:var(--background-secondary] transition-colors w-full"
                                >
                                    <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                                        <path
                                            fill="currentColor"
