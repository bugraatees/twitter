...
export default function Search() {
    ...
    return (
        ...
        >
            <label className="h-[2.688rem] rounded-full bg-[color:var(--secondary-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]">
                <div className="w-[3.5rem] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
                    <svg
                        viewBox="0 0 24 24"
                        className="h-[1.172rem] min-w-[2rem] text-[#71767b] group-focus-within:text-[color:var(--color-primary)] gorup-focus-within:text-[color:var(--color-primary)] "
                    >
                        <path 
                            fill="currentColor"
                ...
                {(query && focus) && (
                    <button
                        type="button"
                        onClick={() => setQuery('')}
                        className="w-[22px] h-[22px] rounded-full bg-[color:var(-v-color-primary)] flex items-center justify-center text-black min-w-[22px] absolute top-1/2 -translate-y-1/2 right-3"
                    >
